    ...
    <section id="systems" className={styles.systems}>
      <div className={styles.inner}>
        ...
        <div className={styles.prose}>
          ...
          <p>
            I started in the trades. A year of electrical foundations before
            construction engineering, and it&rsquo;s why I read a set of
            drawings the way I do.
          </p>
        </div>
        ...
        <p className={styles.dreamJobs}>
          <span className={styles.dreamLabel}>List of dream jobs</span>
          Pro League player, pro basketball player, electrician,
          construction engineer. Different jobs, same thing underneath: run
          the rep, watch what broke, run it again. Takeoffs turned out to be
          the same sport.
        </p>
      </div>
    </section>
