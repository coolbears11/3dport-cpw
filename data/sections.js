...
export const sections = [
  ...
  // the feasibility layer of the JTT work, narrated out on the site while
  // the camera sits among the turbines, the solar field, and the traces
  // running into the hall. `kind: "note"` tells ProjectOverlay to render
    ...
    projects: [
      {
        ...
        description:
          "Generation is developed in one place and consumed in another. Interconnection timelines, easements and substation proximity decide whether the two ever meet \u2014 and they are the first thing I look at on a parcel.",
        alignment: "center",
      },
    ],
  },
    ...
    projects: [
      {
        ...
        description:
          "Five projects, estimated or engineered on the owner\u0027s side and the contractor\u0027s. Preconstruction, quantity takeoffs, conceptual budgets, and the feasibility that comes before all of it.",
        alignment: "left",
      },
    ],
  },
